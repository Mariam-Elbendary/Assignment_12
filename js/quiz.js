...
export default class Quiz {
  ...
  constructor(category, difficulty, numberOfQuestions, playerName, score = 0, questions = [], currentQuestionIndex = 0) {
    ...
    <div class="game-card results-card">
      ...
      <div class="leaderboard">
        ...
        <ul class="leaderboard-list">
                ${scores.map((s, i) => `
                <li class="leaderboard-item ${i === 0 ? 'gold' : i === 1 ? 'silver' : i === 2 ? 'bronze' : ''}">
